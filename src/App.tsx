...
const PublicLogoHubDeepIconAudit = lazyWithRetry(() => import("./pages/PublicLogoHubDeepIconAudit"));
              ...
              <BrandProvider>
                ...
                <Routes>
                  <Route element={<RootLayout />}>
                    ...
                    />
                    <Route
                      path="transperfect-lifesciences-canva-audit"
                      element={
                        <Suspense fallback={<PageSkeleton />}>
                    ...
                    />
                    <Route
                      path="logohub/audit/svgs"
                      element={
                        <Suspense fallback={<PageSkeleton />}>
                          <PublicLogoHubSvgAudit />
                        </Suspense>
                      }
                    />
                    <Route
                    ...
                    />
                    <Route
                      path="logohub/travel-review"
                      element={
                        <Suspense fallback={<PageSkeleton />}>
                          <PublicLogoHubTravelReview />
                        </Suspense>
                      }
                    />
                    <Route
                      path="logohub/travel-qa"
                      element={
                        <Suspense fallback={<PageSkeleton />}>
