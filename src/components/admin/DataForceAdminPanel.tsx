/**
 * DataForce Admin Panel
 * Organization-wide AI usage metrics, compliance trends, and master settings
 */
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold flex items-center gap-2">
            ...
            DataForce Administration
          </h2>
          <p className="text-muted-foreground">
            Organization-wide AI usage, compliance trends & master settings
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-4 gap-4">
                  ...
                  <div className="space-y-1">
                    <div className="flex h-2 rounded-full overflow-hidden bg-muted">
                      <div
                        ...
                        style={{ width: `${(metrics.scoreDistribution.excellent / metrics.completedScans) * 100}%` }}
                      />
                      <div
                        className="bg-amber-500 transition-all"
                        style={{ width: `${(metrics.scoreDistribution.good / metrics.completedScans) * 100}%` }}
                      />
                      <div
                        className="bg-red-500 transition-all"
                        style={{ width: `${(metrics.scoreDistribution.poor / metrics.completedScans) * 100}%` }}
                      />
                    </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.conversationsThisWeek} conversations this week
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.totalValidations} total · {metrics.pendingValidations} pending
                </p>
            ...
            <Card>
              ...
              <CardContent className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.completedTraining} of {metrics.totalTrainingJobs} jobs completed
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          {metrics.recentJobs.length > 0 && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest compliance check results across all organizations
                </CardDescription>
              </CardHeader>
              <CardContent>
