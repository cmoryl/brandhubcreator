...
export const FullBrandPage = ({ 
  ...
  const renderSection = useCallback((sectionId: SectionId) => {
    ...
    switch (sectionId) {
      ...
      case 'social': return <SocialSection social={brand.social} onSocialChange={editHandler((social) => onBrandUpdate({ social }))} customSubtitle={customSubtitle} onSubtitleChange={onSubtitleChange} entityId={brandId} entityType={entityType || 'brand'} organizationId={organizationId} />;
      ...
      case 'website': return <WebsiteSection websites={brand.websites} onWebsitesChange={editHandler((websites) => onBrandUpdate({ websites }))} customSubtitle={customSubtitle} onSubtitleChange={onSubtitleChange} entityName={brand.hero?.name} industry={brand.identity?.archetype} entityId={brandId} entityType={entityType} organizationId={organizationId} brandContext={{ colors: brand.colors?.map?.((c: any) => c.hex) || [], archetype: brand.identity?.archetype, mission: brand.identity?.missionStatement, tagline: brand.hero?.tagline }} />;
      ...
      case 'qr': return <QRSection qr={brand.qr} onQRChange={editHandler((qr) => onBrandUpdate({ qr }))} customSubtitle={customSubtitle} onSubtitleChange={onSubtitleChange} entityType="brand" entityId={brandId} logos={brand.logos} />;
