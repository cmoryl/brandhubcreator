  ...
  * IMPORTANT: This component MUST be rendered inside a MapContainer
  */
  ...
  * Must be used inside MapContainer for useMap() hook to work
  */
 export const MapRegionFilter: React.FC<MapRegionControlProps> = ({
   ...
   // useMap hook - must be called unconditionally at top level
   const map = useMap();
