...
const defaultSignatureTemplate = `<table cellpadding="0" cellspacing="0" style="font-family: Arial, sans-serif;">
  <tr>
  ...
  return (
    <section className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button onClick={addSignature} size="sm" className="gap-2">
