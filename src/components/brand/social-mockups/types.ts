  ...
  'LinkedIn': {
    ...
    sizes: {
      feed: [
        ...
        { name: 'Profile Banner', width: 1584, height: 396, aspectRatio: '4:1', description: 'Personal banner' },
  ...
  'X (Twitter)': {
    ...
    sizes: {
      feed: [
        ...
        { name: 'Header Photo', width: 1500, height: 500, aspectRatio: '3:1', description: 'Profile banner' },
  ...
  'Facebook': {
    ...
    sizes: {
      feed: [
        ...
        { name: 'Cover Photo', width: 820, height: 312, aspectRatio: '2.63:1', description: 'Page cover' },
  ...
  'YouTube': {
    ...
    sizes: {
      feed: [
        ...
        { name: 'Channel Banner', width: 2560, height: 1440, aspectRatio: '16:9', description: 'Channel art' },
