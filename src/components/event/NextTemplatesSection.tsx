  ...
  return (
    <div className="relative h-full w-full overflow-hidden" style={{ backgroundColor: NAVY }}>
      ...
      {layout === 'centered-hero' && (
        ...
        >
          <div style={{ width: '100%', maxWidth: '86%' }}>
            <NextLockup label={verticalLabel} accent={accent} logoUrl={logoUrl} sizeEm={8.5} centered />
          </div>
          <h2
            className="font-bold"
      ...
      {layout === 'left-stack' && (
        <div className="relative z-10 h-full w-full grid grid-cols-2 gap-4" style={{ padding: '1.6em' }}>
          <div className="flex flex-col justify-center">
            <NextLockup label={verticalLabel} accent={accent} logoUrl={logoUrl} sizeEm={7.0} />
          </div>
          <div className="flex flex-col justify-center">
            <h2
              className="font-bold"
      ...
      {layout === 'bottom-band' && (
        <div className="relative z-10 h-full w-full flex flex-col" style={{ padding: '1.6em' }}>
          <div className="flex-1 flex items-start justify-center pt-4">
            <NextLockup label={verticalLabel} accent={accent} logoUrl={logoUrl} sizeEm={7.5} centered />
          </div>
          <div
      ...
      {layout === 'bold-frame' && (
        ...
        >
          <div style={{ maxWidth: '76%' }}>
            <NextLockup label={verticalLabel} accent={accent} logoUrl={logoUrl} sizeEm={6.5} centered />
          </div>
          <h2
      ...
      {layout === 'default' && (
        ...
        >
          <div className={isBanner ? 'flex-shrink-0' : ''} style={{ maxWidth: isBanner ? '52%' : '100%' }}>
            <NextLockup label={verticalLabel} accent={accent} logoUrl={logoUrl} sizeEm={5.5} />
            {(isStory || isTile) && (
            ...
            return (
              ...
              >
                ...
                <div className="aspect-[4/3] relative overflow-hidden">
                  <div className="absolute inset-0" style={{ fontSize: 12 }}>
                    <TemplateSurface
                      format={FORMATS[0]}
