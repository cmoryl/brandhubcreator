...
import { Plus, Check, X, Search, Copy, ArrowRightLeft, Sparkles, ImageIcon, Trash2, FolderPlus } from 'lucide-react';
...
import { ShutterstockSearchDialog } from '@/components/brand/approved-imagery/ShutterstockSearchDialog';
...
export const ImageryWorkspace = ({
  ...
  const handleApproveImages = useCallback((images: ApprovedImage[]) => {
    if (targetSectionId) onAddImages(targetSectionId, images);
  }, [targetSectionId, onAddImages]);
          ...
          {selectionMode && selectedImages.size > 0 && (
            <Button
              ...
              onClick={() => {
                ...
                // Find section name of first image
