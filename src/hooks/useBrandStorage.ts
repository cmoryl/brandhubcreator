...
const dbToBrandGuide = (db: DbBrand): BrandGuide => {
  ...
  return {
    ...
    infographicLayout: (guideData.infographicLayout as BrandGuide['infographicLayout']) || 'pills',
...
const dbToProductGuide = (db: DbProduct): ProductGuide => {
  ...
  return {
    ...
    infographicLayout: (guideData.infographicLayout as ProductGuide['infographicLayout']) || 'pills',
