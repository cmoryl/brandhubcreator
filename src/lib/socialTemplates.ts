...
export const socialTemplates: SocialTemplate[] = [
  ...
  {
    id: 'tp-feed-dual-storyline',
    name: 'Dual Storyline',
    category: 'announcement',
    platforms: ['Instagram', 'LinkedIn', 'Facebook', 'Pinterest', 'Threads'],
    formats: ['feed'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Two-image editorial feed layout with stacked copy and a compact CTA footer.',
    zones: [
      z('image', 6, 8, 42, 36, 'Image A'),
      z('image', 52, 8, 42, 36, 'Image B'),
      z('text', 8, 50, 84, 10, 'Eyebrow', { colorSlot: 'secondary', fontSize: 'sm', align: 'left' }),
      z('text', 8, 62, 62, 16, 'Headline', { colorSlot: 'primary', fontSize: 'lg', align: 'left' }),
      z('cta', 8, 82, 24, 8, 'CTA', { colorSlot: 'accent' }),
      z('logo', 78, 84, 14, 6, 'Logo'),
    ],
  },
  {
    id: 'tp-feed-asymmetric-feature',
    name: 'Asymmetric Feature',
    category: 'product',
    platforms: ['Instagram', 'LinkedIn', 'Facebook', 'YouTube', 'Threads'],
    formats: ['feed'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Large hero image anchored by a smaller supporting frame for feature callouts and campaign proof.',
    zones: [
      z('image', 6, 10, 54, 62, 'Primary Visual'),
      z('image', 66, 10, 24, 22, 'Detail Visual'),
      z('text', 66, 38, 24, 16, 'Feature Headline', { colorSlot: 'primary', fontSize: 'md', align: 'left' }),
      z('text', 66, 58, 24, 12, 'Support Line', { colorSlot: 'secondary', fontSize: 'sm', align: 'left' }),
      z('cta', 6, 80, 22, 8, 'CTA', { colorSlot: 'accent' }),
      z('logo', 76, 82, 14, 6, 'Logo'),
    ],
  },
  {
    id: 'tp-story-split-focus',
    name: 'Split Focus',
    category: 'announcement',
    platforms: VERTICAL_SOCIAL,
    formats: ['story'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Vertical split-frame story with a lead visual, detail insert, and centered conversion path.',
    zones: [
      z('image', 0, 0, 100, 52, 'Top Visual'),
      z('image', 12, 57, 32, 16, 'Detail Frame'),
      z('text', 50, 58, 36, 8, 'Eyebrow', { colorSlot: 'secondary', fontSize: 'sm', align: 'left' }),
      z('text', 12, 76, 76, 11, 'Headline', { colorSlot: 'primary', fontSize: 'lg', align: 'center' }),
      z('cta', 24, 90, 52, 6, 'CTA', { colorSlot: 'accent' }),
      z('logo', 40, 6, 20, 6, 'Logo'),
    ],
  },
  {
    id: 'tp-story-editorial-stack',
    name: 'Editorial Stack',
    category: 'minimal',
    platforms: ['Instagram', 'Facebook', 'Pinterest', 'TikTok', 'YouTube'],
    formats: ['story'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Top-to-bottom story stack with two framed visuals and a lower-third message block.',
    zones: [
      z('logo', 10, 6, 18, 6, 'Logo'),
      z('image', 10, 16, 80, 26, 'Upper Visual'),
      z('image', 18, 46, 64, 18, 'Secondary Visual'),
      z('text', 12, 68, 76, 10, 'Headline', { colorSlot: 'primary', fontSize: 'lg', align: 'center' }),
      z('text', 18, 80, 64, 6, 'Support Copy', { colorSlot: 'secondary', fontSize: 'sm', align: 'center' }),
      z('cta', 24, 90, 52, 6, 'CTA', { colorSlot: 'accent' }),
    ],
  },
  {
    id: 'tp-reel-split-caption',
    name: 'Split Caption Reel',
    category: 'video',
    platforms: ['Instagram', 'Facebook', 'TikTok', 'YouTube'],
    formats: ['reel'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Motion frame with top video window, lower caption system, and branded action strip.',
    zones: [
      z('logo', 8, 6, 16, 5, 'Logo'),
      z('image', 8, 14, 84, 46, 'Video Window'),
      z('text', 10, 66, 70, 10, 'Hook Headline', { colorSlot: 'primary', fontSize: 'lg', align: 'left' }),
      z('text', 10, 78, 52, 6, 'Subhead', { colorSlot: 'secondary', fontSize: 'sm', align: 'left' }),
      z('cta', 62, 88, 26, 5, 'Watch', { colorSlot: 'accent' }),
    ],
  },
  {
    id: 'tp-reel-dual-panel',
    name: 'Dual Panel Reel',
    category: 'product',
    platforms: ['Instagram', 'Facebook', 'TikTok', 'YouTube'],
    formats: ['reel'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Two-panel vertical reel for before/after, market comparisons, or proof-vs-message storytelling.',
    zones: [
      z('image', 8, 12, 38, 58, 'Panel A'),
      z('image', 54, 12, 38, 58, 'Panel B'),
      z('text', 10, 74, 80, 10, 'Comparison Headline', { colorSlot: 'primary', fontSize: 'lg', align: 'center' }),
      z('cta', 24, 88, 52, 5, 'Explore', { colorSlot: 'accent' }),
      z('logo', 38, 4, 24, 5, 'Logo'),
    ],
  },
  {
    id: 'tp-cover-split-panorama',
    name: 'Split Panorama',
    category: 'cover',
    platforms: COVER_SOCIAL,
    formats: ['cover'],
    colorSlots: ['primary', 'secondary', 'accent'],
    description: 'Wide cover with panoramic hero art plus an inset secondary frame for campaign or channel context.',
    zones: [
      z('image', 0, 0, 100, 100, 'Hero Panorama'),
      z('image', 68, 18, 18, 42, 'Inset Frame'),
      z('text', 16, 30, 34, 12, 'Headline Safe Area', { colorSlot: 'primary', fontSize: 'lg', align: 'left' }),
      z('text', 16, 46, 28, 8, 'Descriptor', { colorSlot: 'secondary', fontSize: 'sm', align: 'left' }),
      z('cta', 16, 62, 18, 9, 'CTA', { colorSlot: 'accent' }),
      z('logo', 84, 14, 8, 14, 'Logo'),
    ],
  },
  {
    id: 'tp-cover-center-stage',
    name: 'Center Stage Cover',
    category: 'cover',
    platforms: ['YouTube', 'LinkedIn', 'Facebook', 'X', 'X (Twitter)'],
    formats: ['cover'],
    colorSlots: ['primary', 'secondary'],
    description: 'Center-safe banner with symmetric frame placement for predictable crops across desktop and mobile.',
    zones: [
      z('image', 0, 0, 100, 100, 'Background Image'),
      z('text', 30, 28, 24, 12, 'Headline', { colorSlot: 'primary', fontSize: 'lg', align: 'center' }),
      z('text', 33, 46, 18, 8, 'Subhead', { colorSlot: 'secondary', fontSize: 'sm', align: 'center' }),
      z('logo', 44, 62, 12, 16, 'Logo'),
    ],
  },
  {
    id: 'tp-profile-frame-badge',
    name: 'Frame Badge',
    category: 'profile',
    platforms: PROFILE_SOCIAL,
    formats: ['profile'],
    colorSlots: ['primary', 'accent'],
    description: 'Profile/icon template with framed background image, centered mark, and bottom label chip.',
    zones: [
      z('image', 14, 14, 72, 72, 'Background Frame'),
      z('logo', 31, 26, 38, 30, 'Logo Mark'),
      z('text', 20, 64, 60, 10, 'Label', { colorSlot: 'accent', fontSize: 'sm', align: 'center' }),
    ],
  },
];
