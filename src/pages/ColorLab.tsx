 ...
 * - WCAG contrast checking (AA/AAA) with all pair combinations
...
import {
  ...
  ChevronDown, ChevronUp, ArrowLeft, Droplets, Sun, Pipette,
  Import, AlertTriangle, CheckCircle2, Info,
} from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[10px] text-muted-foreground">Accessibility · Print · Digital</p>
              </div>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {colors.length < 2 && (
          <div className="text-center py-16 text-muted-foreground">
            ...
            <p className="text-sm">Add at least 2 colors to start accessibility testing</p>
          </div>
        )}
      </main>
    </div>
