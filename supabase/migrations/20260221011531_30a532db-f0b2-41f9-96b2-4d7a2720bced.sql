...
BEGIN
  ...
  -- Fetch persisted website analysis reports (fixed: use subquery for ORDER BY + LIMIT with jsonb_agg)
  ...
  -- Fetch booth AI analyses (fixed: use subquery for ORDER BY + LIMIT with jsonb_agg)
  SELECT jsonb_agg(jsonb_build_object(
